						...
						<div class="row align-items-center pt-5">
							...
							<div class="col-lg-6 col-md-12">
								<div class="hero-content pl-4">
									<h1>Scanning QR is easy now. </h1>
                                    <p>Create QR Codes for 100% free, no Signup or Credit Card required.</p>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-pricing-table left-align">
                                        ...
                                        <ul class="pricing-features">
                                            ...
                                            <li>
                                                <i class="bx bxs-badge-check"></i>
                                                Visitor Notes <span class="tooltips bx bxs-info-circle" data-toggle="tooltip" data-placement="right" title="Tight pants next level keffiyeh you probably haven't heard of them."></span>
                                            </li>
                                            <li><i class="bx bxs-badge-check"></i> Google Analytics</li>
                                        </ul>
